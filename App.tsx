  ...
  return new Promise((resolve, reject) => {
    ...
    img.onload = () => {
      try {
        ...
        const logoSize = Math.max(img.width, img.height)*1.01; // 100% del tamaño mayor
        const centerX = img.width / 2;
        //const nadirY = img.height * 0.85; // 85% hacia abajo
        const nadirY = img.height * 0.94; // 94% hacia abajo
	...
	const svgData = `<svg width="${logoSize}" height="${logoSize}*.15" viewBox="0 0 7070 600" xmlns="http://www.w3.org/2000/svg">
	...
	<rect x="0" y="-10" width="${logoSize}" height="50" fill="#632e0d" />
	<rect x="0" y="0" width="${logoSize}" height="500" fill="#92400e" />
	<rect x="0" y="200" width="${logoSize}.5" height="400" fill="#632e0d" />	
	<rect x="3535" y="200" width="${logoSize}*.5" height="400" fill="#331c0e" />
 	<text x="3535" y="120" font-size="130" fill="white" text-anchor="middle" font-family="sans-serif" letter-spacing="155">360 GmedranoTIC studio - 2026 - </text>
