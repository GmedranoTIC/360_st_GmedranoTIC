...
async function addLogoToNadir(imageSrc: string): Promise<string> {
  ...
  return new Promise((resolve, reject) => {
	...
	<rect x="${logoSize}*.5" y="400" width="${logoSize}*.5" height="400" fill="#331c0e" />
 	<text x="${logoSize}*.5" y="120" font-size="130" fill="white" text-anchor="middle" font-family="sans-serif" letter-spacing="155">360 GmedranoTIC studio - 2026 - </text>
