...
async function addLogoToNadir(imageSrc: string): Promise<string> {
  ...
  return new Promise((resolve, reject) => {
	...
	const svgData = `<svg width="${logoSize}" height="${logoSize}*.15" viewBox="0 0 7050 400" xmlns="http://www.w3.org/2000/svg">
	...
	<rect x="0" y="0" width="7050" height="400" fill="#92400e" stroke="#fff" stroke-width="0"/>
 	//<text x="3500" y="130" font-size="160" font-weight="bold" fill="white" text-anchor="middle" font-family="sans-serif" letter-spacing="140">360 GmedranoTIC studio - 2026 - </text>
 	<text x="3500" y="110" font-size="160" fill="white" text-anchor="middle" font-family="sans-serif" letter-spacing="140">360 GmedranoTIC studio - 2026 - </text>
