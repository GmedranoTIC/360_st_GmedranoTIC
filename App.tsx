...
async function addLogoToNadir(imageSrc: string): Promise<string> {
  ...
  return new Promise((resolve, reject) => {
	...
	const svgData = `<svg width="${logoSize}" height="${logoSize}*.15" viewBox="0 0 7050 350" xmlns="http://www.w3.org/2000/svg">
	...
	<rect x="0" y="0" width="7050" height="300" fill="#92400e" stroke="#fff" stroke-width="0"/>
