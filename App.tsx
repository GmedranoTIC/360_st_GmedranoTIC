...
async function addLogoToNadir(imageSrc: string): Promise<string> {
  ...
  return new Promise((resolve, reject) => {
	...
	const svgData = `<svg width="${logoSize}" height="${logoSize}*.15" viewBox="0 0 ${logoSize}*1.01 600" xmlns="http://www.w3.org/2000/svg">
	...
	<rect x="0" y="-10" width="${logoSize}*1.01" height="50" fill="#ffff00" stroke="#fff" stroke-width="0"/>
	<rect x="0" y="0" width="${logoSize}*1.01" height="500" fill="#92400e" stroke="#fff" stroke-width="0"/>
	<rect x="0" y="500" width="${logoSize}*1.01" height="200" fill="#ffff00" stroke="#fff" stroke-width="0"/>
 	<text x="${logoSize}/2" y="120" font-size="130" fill="white" text-anchor="middle" font-family="sans-serif" letter-spacing="155">360 GmedranoTIC studio - 2026 - </text>
