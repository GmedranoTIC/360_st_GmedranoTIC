...
async function addLogoToNadir(imageSrc: string): Promise<string> {
  ...
  return new Promise((resolve, reject) => {
	...
	<rect x="0" y="0" width="7050" height="50" fill="#ffff00" stroke="#fff" stroke-width="0"/>
	<rect x="0" y="0" width="${logoSize}" height="500" fill="#92400e" stroke="#fff" stroke-width="0"/>
	<rect x="0" y="500" width="7050" height="200" fill="#ffff00" stroke="#fff" stroke-width="0"/>
 	<text x="3500" y="120" font-size="130" fill="white" text-anchor="middle" font-family="sans-serif" letter-spacing="155">360 GmedranoTIC studio - 2026 - </text>
